...
<section id="mre-about-us" style="background-image: url('<?php echo $aboutUs[0]['_hf_about_us_background']; ?>');"
        ...
        <div class="about-buttons">
			...
			<?php if ( ! empty( $aboutUs[0]['_hf_about_button_url'] ) ) { ?>
                <a href="<?php echo $aboutUs[0]['_hf_about_button_url'] ?>" class="about-us-button" download>
					...
					<?php } else { ?>
						<?php echo( ! empty( $aboutUs[0]['_hf_about_button_text'] ) ? $aboutUs[0]['_hf_about_button_text'] : "Descargar Brochure" ) ?>
					<?php } ?>
                </a>
			<?php } ?>
        </div>
...
<section id="mre-partners" class="container-fluid no-padding">
    <div class="col-xs-12 col-md-6 partner-left"
         style="background-image: url('<?php if ( isset( $partnerLeft[0]["_hf_partner_left_background"] ) ) {
		     echo $partnerLeft[0]["_hf_partner_left_background"];
	     } ?>');">
    ...
    <div class="col-xs-12 col-md-6 partner-right"
         style="background-image: url('<?php if ( isset( $partnerRight[0]["_hf_partner_right_background"] ) ) {
		     echo $partnerRight[0]["_hf_partner_right_background"];
	     } ?>');">
