					...
					<form id="property-search" class="property-search" action="<?php echo esc_url(home_url('/'.$language_subdir)); ?>" method="get" role="form"
						...
						<ul class="property-status">
							<li class="col-xs-4 col-sm-4 col-md-4 no-padding">
								<a href="<?php echo home_url() . ( $lang == "es_ES" ? '/compra' : '/buy' ); ?>" class="active"><?php echo ( $lang == "es_ES" ? 'Compra' : 'Buy' ) ?></a>
							</li>
							<li class="col-xs-4 col-sm-4 col-md-4 no-padding">
        ...
        <div class="row">
            <div class="col-md-12 text-center">
				<form  action="<?php echo esc_url( admin_url('admin-post.php') ) ?>" method="post" role="form" >
					...
					<input type="hidden" name="subdir" value="<?php $lang == "es_ES" ? '/compra' : '/buy' ?>" >
