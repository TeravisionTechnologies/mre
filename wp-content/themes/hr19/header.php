...
<head>
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAqLg2ArgqBdOHK6Nmro4hoJ0ixlBurD_s&callback=initialize"></script>
    <?php wp_head(); ?>
    <!-- FIX HTML STYLES IE9 -->
    <!--[if gte IE 9]>
    <style type="text/css">
      ...
      <div class="container">
        ...
        <div class="logo-header">
          <div class="img-div pull-right text-center">
            <a href="<?php echo home_url(); ?>"><img src="<?php echo $theMeta['_hf_header_logo'][0];  ?>" alt="HR19 Logo"></a>
          </div>
        </div>
