...
?>
  ...
  <section class="col-xs-12 hr-partners-section text-center">
    ...
    <div class="hr-partners-images">
      <a href="<?php echo $partners[0]['_hf_partner_link_left']; ?>"><img src="<?php echo $partners[0]['_hf_partner_logo_left']; ?>" alt="Logo ALA19" class="partners-images-one"/></a>
      <a href="<?php echo $partners[0]['_hf_partner_link_right']; ?>"><img src="<?php echo $partners[0]['_hf_partner_logo_right']; ?>" alt="Logo MRE RealEstate" class="partners-images-two"/></a>
    </div>
  </section>
  <section class="col-xs-12 hr-rentalone-section text-center no-padding" style="background-image: url('<?php echo $rental[0]["_hf_rental_background"] ?>')">
    <div class="hr-rentalone-overlay">
      ...
      <div class="rentalone-button"><a href="<?php echo $rental[0]["_hf_rental_link"] ?>">Ver más</a></div>
    </div>
  </section>
