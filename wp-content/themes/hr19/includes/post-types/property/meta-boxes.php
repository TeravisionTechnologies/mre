...
function property_metaboxes() {
	...
	$cmb_property->add_field( array(
		'name' => '<div style="background: #23282d;color: #fff;padding: 10px">PROPIEDADES EN PREVENTA - HR19</div>',
		'desc' => 'Los campos a continuacion pertenecen a las propiedades que seran mostradas con la plantilla de ALA19',
		'type' => 'title',
		'id'   => 'preventa_title'
	) );
