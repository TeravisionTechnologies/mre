            ...
            <div class="col-md-offset-1 col-md-10">
                <form id="property-search" class="property-search"
                    ...
                    <ul class="property-status">
                        ...
                        <li class="col-xs-4 col-sm-4 col-md-4 no-padding">
                            <a href="<?php echo home_url() . ( $lang == "es_ES" ? '/preventa' : '/presale' ) ?>"
                               class="active"><?php echo( $lang == "es_ES" ? 'Preventa' : 'Presale' ) ?></a>
                        </li>
                    </ul>
                    <div class="col-xs-12 col-sm-12 col-md-12 search-text no-padding">
                        <div class="input-group">
                            ...
                            <!--<input type="hidden" id="property_status" name="property_status" value="Presale">-->
...
<div id="presale-list" class="container property-list">
    ...
    <div class="row">
        <div class="col-md-12 text-center">
            <form id="property_lenguage" action="<?php home_url( $lang == "es_ES" ? '/preventa' : '/presale' ); ?>"
                  method="get" role="form" data-toggle="validator" data-disable="false">
                <ul class="country-selector">
					<?php if ( $country == 'spain' ) : ?>
                        <li><a href="#" id="usa" data-value="usa"><?php echo( $lang == "es_ES" ? 'EEUU' : 'USA' ) ?></a>
                        </li>
                        <li class="divider"></li>
