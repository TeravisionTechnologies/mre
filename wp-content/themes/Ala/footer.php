    ...
    <footer class="al-footer-container col-xs-12">
        <div class="container">
            <div class="col-xs-12 text-center">
                ...
                <a class="al-text-white" style="cursor: default;">Disclaimers</a>
            </div>
        </div>
    ...
    <div class="menu">
        <div class="menu-wrapper">
			<?php wp_nav_menu( array(
				...
				'container'      => false,
				'menu_class'     => "al-menu c-menu__items"
			) ); ?>
            <div class="al-menu-language">
                ...
                <a href="<?php echo $languages['en']['url'] ?>"><img class="al-menu-language-flag <?php echo ( $lang == "en_US" ? 'language-flag-active' : '' ) ?>"
                                                                     ...
                                                                     alt="Inglés"></a>
                <a href="<?php echo $languages['es']['url'] ?>"><img class="al-menu-language-flag <?php echo ( $lang == "es_ES" ? 'language-flag-active' : '' ) ?>"
