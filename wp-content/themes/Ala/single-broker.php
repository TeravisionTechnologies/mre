                    ...
                    <?php if ($terms != null) { ?>
                        <div class="row gallery-places">
                            <?php $i = 1; $counter = 0; foreach ($terms as $term) {
                                ...
                                ?>
                                <div class="col-sm-4 col-md-4">
                                    <a class="amenimg places-wrapper gallery-nearby" data-number="<?php echo $counter; ?>" data-toggle="modalx" data-target="#myModalNearbyx" style="background: url('<?php echo $meta_image; ?>')">
